...
const Banner = () => {
    ...
    return (
        <div>
            <div className="card lg:card-side bg-base-100 shadow-xl items-center my-7">
                <figure><img className='w-[80%] ' data-aos="fade-up-right" src="https://i.ibb.co/zVZMRJM/istockphoto-1467920800-170667a.webp" alt="Album" /></figure>
